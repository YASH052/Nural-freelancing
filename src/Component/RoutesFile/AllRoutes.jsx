...
import AddAgency from "../Pages/Master/Agency/AddAgency";
import PreBookingSku from "../Pages/Master/ISP Master/PreBookinSku/PreBookingSku";
import ManagCompetitionData from "../Pages/SideMenuPages/Competition/ManageCompetitionData/ManageCompetitionData";
import ManageTask from "../Pages/SideMenuPages/Merchandizing/ManageTask/ManageTask";
    ...
    <Row className="">
      <Suspense fallback={<Loader />}>
        <Routes>
          ...
          <Route path="/prebookingsku" element={<PreBookingSku />} />
          <Route
            path="/managecompetitiondata"
            element={<ManagCompetitionData />}
          />
